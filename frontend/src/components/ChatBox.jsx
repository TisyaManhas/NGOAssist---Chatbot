  ...
  return (
    <div className="w-full h-screen items-center flex justify-center">
        <div className="md:w-[45%] w-[70%] h-[70%] shadow-2xl rounded-3xl border-black border-2 overflow-hidden flex flex-col items-center">
            <div className="w-full border-black border-b-2 h-[13%] bg-pink-600 "><h2>\tKat-Bot</h2></div>
            ...
            <button className="border-black ml-2 border-2 bg-white rounded-xl h-[70%] md:px-2 px-1 text-sm md:text-lg " img='/src/images/message.png'>Send!</button>
            </div>
        </div>
    </div>
  )
